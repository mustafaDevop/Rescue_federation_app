...
import { registerCustomer, registerAdmin } from '../../hooks/requestInstance';
            ...
            <View style={styles.loadingContainer}>
                <View style={styles.loadingContent}>
                    ...
                    <Text style={styles.loadingTitle}>
                        Creating {userType === 'user' ? 'Patient' : 'Admin'} Account
                    </Text>
...
export default function RegisterPage() {
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            showToast(
                `Your ${activeTab === 'user' ? 'patient' : 'admin'} account has been created successfully! 🎉`,
                'success'
            );
            ...
            if (error.code === 400) {
                showToast(error.message || 'Invalid registration data. Please check your information.');
            } else if (error.code === 409) {
                showToast('An account with this email already exists. Please try logging in instead.');
    ...
    const isFormValid = email && password && name && confirmPassword && passwordsMatch && password.length >= 6;
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Ionicons 
                                    name={activeTab === 'user' ? 'person-add' : 'shield-checkmark'} 
                                    size={32} 
                                    color="white" 
                                />
                            </LinearGradient>
                            ...
                            <Text style={styles.title}>
                                {activeTab === 'user' ? 'Join MediCare' : 'Admin Registration'}
                            </Text>
                            <Text style={styles.subtitle}>
                                {activeTab === 'user' 
                                    ? 'Create your account and start your healthcare journey'
                                    : 'Register as admin to manage the healthcare platform'
                                }
                            </Text>
                        </Animated.View>
                            ...
                            <View style={styles.passwordRequirements}>
                                ...
                                <View style={styles.requirementItem}>
                                    <Ionicons
                                        ...
                                        size={16}
                                        color={password.length >= 6 ? '#48bb78' : '#a0aec0'}
                                    />
                                    <Text style={[
                                ...
                                <View style={styles.requirementItem}>
                                    <Ionicons
                                        name={passwordsMatch && confirmPassword ? 'checkmark-circle' : 'ellipse-outline'}
                                        size={16}
                                        color={passwordsMatch && confirmPassword ? '#48bb78' : '#a0aec0'}
                                    />
                                    <Text style={[
                                        styles.requirementText,
                                        passwordsMatch && confirmPassword && styles.requirementMet,
                                        !passwordsMatch && confirmPassword && styles.requirementError
                                    ]}>
                                        Passwords match
                                    </Text>
                                </View>
                            ...
                            >
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <Text style={styles.buttonText}>
                                            {activeTab === 'user' ? 'Create Account' : 'Register as Admin'}
                                        </Text>
                                    )}
                                </LinearGradient>
                            </TouchableOpacity>
                        ...
                        <View style={styles.footer}>
                            <Text style={styles.footerText}>
                                {activeTab === 'user' ? 'Already have an account? ' : 'Already have admin account? '}
                            </Text>
                            <Link href="/login" asChild>
                                <TouchableOpacity>
                                    <Text style={styles.link}>
                                        {activeTab === 'user' ? 'Sign in' : 'Admin login'}
                                    </Text>
                                </TouchableOpacity>
                            </Link>
                        </View>
